...
def viz_nerf(images, depths, valid_depths, poses, intrinsics, i_split, args, scene_sample_params, lpips_alex, gt_depths, gt_valid_depths, all_depth_hypothesis, is_init_scales=False, \
    ...
    with torch.no_grad():
      ...
      curr_pnm_rgb_term1, curr_pnm_feature_term1, curr_potentials_term1 = torch.split(DATABASE1, [3, 3, 3], dim=-1)
      ...
      curr_pnm_rgb_term2, curr_pnm_feature_term2, curr_potentials_term2 = torch.split(DATABASE2, [3, 3, 3], dim=-1)
    ...
    with torch.no_grad():
      ...
      for idx in range(0, len(i_train), skip_view):
        ...
        save_motion_vectors(pc1, colors1, potentials1.detach().cpu().numpy(), fname + "_init_potentials1.png")
        save_motion_vectors(pc1, colors1, potentials1.detach().cpu().numpy(), fname + "_init_potentials1_endpt.png", is_vec=False)
        ...
        save_pointcloud_samples(pc2, colors2, fname + "_pc2_wholevec.png")
