...
def viz_nerf(images, depths, valid_depths, poses, intrinsics, i_split, args, scene_sample_params, lpips_alex, gt_depths, gt_valid_depths, all_depth_hypothesis, is_init_scales=False, \
    ...
    with torch.no_grad():
      ...
      save_pointcloud_samples(pc1_flowed, color1, os.path.join(result_dir, "000_database_pcflowed_1to2.png"), pc_size=0.05, skip=1)
      ...
      save_pointcloud_samples(pc2_flowed, color2, os.path.join(result_dir, "000_database_pcflowed_2to1.png"), pc_size=0.05, skip=1)
