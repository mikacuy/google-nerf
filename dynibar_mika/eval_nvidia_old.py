...
from ibrnet.model import DynibarFF, DynibarZQ
from ibrnet.projection import Projector
from ibrnet.render_image import render_single_image_nvi, render_single_image
  ...
  for img_i in range(10, args.num_frames - 3): 
    ...
    for i, data in enumerate(test_loader):
      ...
      with torch.no_grad():
        ...
        cb_src_rgbs = ray_batch['src_rgbs'].squeeze(0).permute(0, 3, 1, 2)

        cb_featmaps_1, _ = model.feature_net(cb_src_rgbs)
        ref_featmaps, anchor_featmaps = cb_featmaps_1, None
      ...
      fine_pred_depth = ret['outputs_coarse_ref']['depth'].detach().cpu().numpy()
