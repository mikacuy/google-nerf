...
# parser.add_argument('--dump_dir', default= "dump_1102_scene0710_single_mean/", type=str)
# parser.add_argument('--dump_dir', default= "dump_1102_scene0758_single_mean/", type=str)
# parser.add_argument('--dump_dir', default= "dump_1102_scene0781_single_mean/", type=str)
# parser.add_argument('--dump_dir', default= "dump_1102_scene0708_single_mean/", type=str)
# parser.add_argument('--dump_dir', default= "dump_1102_scene0738_single_mean/", type=str)
...
parser.add_argument('--dump_dir', default= "dump_1114_lounge_v3_single_mean/", type=str)
# parser.add_argument('--dump_dir', default= "dump_1114_b_kitchen_single_mean/", type=str)
# parser.add_argument('--dump_dir', default= "dump_1114_basement_part2_single_mean/", type=str)
...
with torch.no_grad():
    ...
    for i, data in enumerate(zcache_dataloader):
        ...
        pred_single_depth = np.mean(all_pred_depths, axis=0)

        ### Mean of all depth maps
        plt.imsave(os.path.join(DUMP_DIR, img_name+'-depthmean.png'), pred_single_depth, cmap='rainbow')
