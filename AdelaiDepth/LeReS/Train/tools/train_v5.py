...
parser.add_argument("--logdir", default="log_test5/", help="path to the log directory", type=str)
...
parser.add_argument('--mlp_lr2', default= 0.000001, type=float)
...
if ADA_VERSION == "v2":
    model = RelDepthModel_cIMLE_decoder(d_latent=D_LATENT, version="v2")
elif ADA_VERSION == "v3":
    model = RelDepthModel_cIMLE_decoder(d_latent=D_LATENT, version="v3")
else:
    print("Not a valid adain version.")
    exit()
