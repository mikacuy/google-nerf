...
python render_ucsd_space-time.py --config configs_ucsd/eval_ucsd_scene026.txt
...
class DynamicVideoDataset(Dataset):
    def __init__(self, args,
        ...
        for i, scene in enumerate(scenes):
            ...
            _, poses, bds, render_poses, i_test, rgb_files, scale = load_llff_data(scene_path, first_imgs=10,
...
if __name__ == '__main__':
    ...
    try:
        ...
        imageio.mimwrite(os.path.join(extra_out_dir, '{}.mp4'.format(args.expname)), out_frames, fps=25, quality=8)
