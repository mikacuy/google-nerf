...
def config_parser():
    ...
    parser.add_argument("--decay_base", type=int, default=20, help='rank for distributed training')
    parser.add_argument("--erosion_radius", type=int, default=1, help='rank for distributed training')
    ...
    parser.add_argument('--st_alpha_threshold', type=float, default=1e-2, help='st_alpha_threshold')
