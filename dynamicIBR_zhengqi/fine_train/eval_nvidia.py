''''
CUDA_VISIBLE_DEVICES=0,1 python eval_nvidia.py --config configs_nvidia/eval_jumping_long.txt
CUDA_VISIBLE_DEVICES=2,3 python eval_nvidia.py --config configs_nvidia/eval_skating_long.txt
python eval_nvidia.py --config configs_nvidia/eval_playground_long.txt
python eval_nvidia.py --config configs_nvidia/eval_balloon1_long.txt
python eval_nvidia.py --config configs_nvidia/eval_balloon2_long.txt

CUDA_VISIBLE_DEVICES=4,5 python eval_nvidia.py --config configs_nvidia/eval_truck_long.txt
python eval_nvidia.py --config configs_nvidia/eval_umbrella_long.txt
CUDA_VISIBLE_DEVICES=6,7 python eval_nvidia.py --config configs_nvidia/eval_playground_long.txt
CUDA_VISIBLE_DEVICES=4,5 python eval_nvidia.py --config configs_nvidia/eval_balloon1_long.txt
CUDA_VISIBLE_DEVICES=2,3 python eval_nvidia.py --config configs_nvidia/eval_dynamicFace_long.txt
CUDA_VISIBLE_DEVICES=0,1 python eval_nvidia.py --config configs_nvidia/eval_balloon2_long.txt

CUDA_VISIBLE_DEVICES=6,7 python eval_nvidia.py --config configs_nvidia/eval_jumping_long.txt
...
if __name__ == '__main__':
    ...
    for img_i in tqdm(range(3, args.num_frames-3)):#args.num_frames-3):
        ...
        for i, data in enumerate(test_loader):
            ...
            if False:
                ...
                imageio.imwrite(os.path.join(out_scene_dir, 'pred_%03d_%03d_depth.png'%(img_i, i)), fine_pred_depth)
    ...
    print("extra_out_dir ", extra_out_dir)
