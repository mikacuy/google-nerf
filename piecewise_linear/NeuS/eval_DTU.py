...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='/orion/u/mikacuy/coordinate_mvs/piecewise_linear/NeuS/DTU_data_eval')
    parser.add_argument('--vis_out_dir', type=str, default='out_eval')
