...
def run_nerf():
    ...
    json_fname =  os.path.join("video_demo_poses", "transforms_mic.json")
    ...
    ############
    curr_num_samples = num_samples_more + 10
    start_pose = v22
    end_pose = back_near
    ...
    with open(os.path.join(scene_data_dir, "transforms_video_demo" + str(i) +".json"), "w") as outfile:
        json.dump(data, outfile)

    print(os.path.join(scene_data_dir, "transforms_video_demo" + str(i) +".json"))
    print()
    print("Num frames: ")
    print(len(frames))
