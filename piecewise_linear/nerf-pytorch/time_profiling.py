...
def config_parser():
    ...
    parser.add_argument("--constant_init",   type=int, default=0, 
...
def train():
    ...
    if args.task == "train":
        ...
        for i in trange(start, N_iters):
            ...
            LOG_FOUT = open(os.path.join(args.ckpt_dir, args.expname, 'profile_forward.txt'), 'w')

            total_time = time.time() - start_time
            print( f"Forward time {total_time}")
            LOG_FOUT.write("Forward time: " + str(total_time)+'\n')
            ...
            total_time = time.time() - start_time
            print( f"Backward time {total_time}")
            LOG_FOUT.write("Backward time: " + str(total_time)+'\n')
