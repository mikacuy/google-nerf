...
def config_parser():
    ...
    parser.add_argument("--netchunk", type=int, default=1024*64, ß
...
def train():
    ...
    if args.task == "train":
        ...
        for i in trange(start, N_iters):
            ...
            if global_step > args.start_decay_lrate and global_step <= args.end_decay_lrate:
                portion = (global_step - args.start_decay_lrate) / (args.end_decay_lrate - args.start_decay_lrate)
                decay_rate = 0.1
