...
#SBATCH --job-name=scan21_40_lower
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-scan21_40_lower-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu_linear_improved_lower_lr.txt --num_train 40  --data_dir /orion/group/mvs_training/dtu  --dtu_scene_id 21 --expname log_dtu_scan21_40views_linearimproved_constantinit_coarseinit2000_lr1e-4 --i_img 500 
echo "Done"
