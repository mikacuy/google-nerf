...
#SBATCH --job-name=const_30_dtu2
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-const_30_dtu2-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_constant.txt --num_train 40  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 21 --expname log_dtu2_scan21_30views_constant_lr5e-4 --i_img 2000
echo "Done"
