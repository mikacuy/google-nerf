...
#SBATCH --job-name=linear_45
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-linear_45-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_linear_improved.txt --num_train 40  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 45 --expname scan45_linear --i_img 10000
echo "Done"
