...
#SBATCH --job-name=scan21_30_higher_dtu2
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-scan21_30_higher_dtu2-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_linear_improved_higher_lr.txt --num_train 30  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 21 --expname log_dtu2_scan21_30views_linearimproved_constantinit_coarseinit2000_lr1e-3 --i_img 2000
echo "Done"
