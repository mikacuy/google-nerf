...
#SBATCH --job-name=scan21_20
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-scan21_20-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu_linear_improved.txt --num_train 20  --data_dir /orion/group/mvs_training/dtu  --dtu_scene_id 21 --expname log_dtu_scan21_20views_linearimproved_constantinit_coarseinit2000_lr5e-4 --i_img 500
