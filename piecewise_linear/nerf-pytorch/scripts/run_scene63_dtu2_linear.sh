...
#SBATCH --job-name=l_63
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-l_63-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_linear_improved.txt --num_train 40  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 63 --expname repick_scan63_linear --i_img 10000
echo "Done"