...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_linear_improved.txt --num_train 40  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 30 --expname repick_scan30_linear --i_img 10000
echo "Done"
