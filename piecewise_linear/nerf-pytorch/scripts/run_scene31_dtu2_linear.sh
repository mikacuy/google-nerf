...
#SBATCH --job-name=l_31
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-l_31-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_linear_improved.txt --num_train 40  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 31 --expname repick_scan31_linear --i_img 10000
echo "Done"
