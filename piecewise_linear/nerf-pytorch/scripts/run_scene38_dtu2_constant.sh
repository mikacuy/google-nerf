...
#SBATCH --job-name=c_38
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-c_38-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu2_constant.txt --num_train 40  --data_dir /orion/group/rs_dtu_4/DTU  --dtu_scene_id 38 --expname repick_scan38_constant --i_img 10000
echo "Done"
