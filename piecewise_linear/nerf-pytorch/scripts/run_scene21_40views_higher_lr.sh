...
#SBATCH --job-name=scan21_40_higher
#SBATCH --output=/orion/u/w4756677/slurm_dump/slurm-scan21_40_higher-%j.out
...
conda activate nerf
python run_nerf_constantinit.py --task train --config configs/dtu_linear_improved_higher_lr.txt --num_train 40  --data_dir /orion/group/mvs_training/dtu  --dtu_scene_id 21 --expname log_dtu_scan21_40views_linearimproved_constantinit_coarseinit2000_lr1e-3  --i_img 2000
echo "Done"
