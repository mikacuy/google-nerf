...
parser.add_argument('distance_ratio', type=float, help='Distance ratio')
...
RESULTS_PATH = '%s_results_nv%d_%s' % (args.name, VIEWS, DISTANCE_RATIO)
DEPTH_SCALE = 1.4
COLOR_DEPTH = 8
FORMAT = 'PNG'
RANDOM_VIEWS = True
...
cam.location = (0, 4.0 * DISTANCE_RATIO, 0.5 * DISTANCE_RATIO)
