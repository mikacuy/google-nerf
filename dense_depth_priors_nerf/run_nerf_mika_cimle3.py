...
from model import NeRF_deeper_viewlinear2, get_embedder, get_rays, precompute_quadratic_samples, sample_pdf, sample_pdf_joint, img2mse, mse2psnr, to8b, \
...
def create_nerf(args, scene_render_params):
    ...
    model = NeRF_deeper_viewlinear2(D=args.netdepth, W=args.netwidth,
    ...
    if args.N_importance > 0:
        model_fine = NeRF_deeper_viewlinear2(D=args.netdepth_fine, W=args.netwidth_fine,
                          input_ch=input_ch, output_ch=output_ch, skips=skips,
                          input_ch_views=input_ch_views, input_ch_cam=args.input_ch_cam, use_viewdirs=args.use_viewdirs)
