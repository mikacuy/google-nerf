...
def get_rays(directions, c2w):
    ...
    if c2w.ndim==2:
        ...
        ##Debugging scannet. --> works!
        rays_d = torch.bmm(rearrange(directions, 'n c -> n 1 c'), c2w.unsqueeze(0).repeat(directions.shape[0], 1, 1)[..., :3].permute(0,1,2))
        ...
        ##Debugging scannet --> works!
        rays_d = torch.bmm(rearrange(directions, 'n c -> n 1 c'), c2w[..., :3].permute(0,1,2))
