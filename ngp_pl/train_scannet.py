...
class NeRFSystem(LightningModule):
    def __init__(self, hparams):
        ...
        self.model = NGP(scale=hparams.scale, num_levels=hparams.num_levels)
    ...
    def setup(self, stage):
        ...
        kwargs = {'root_dir': hparams.root_dir,
                  ...
                  'test_skip': hparams.test_skip,
                  "rot_transpose":hparams.rot_transpose,
                  "scale_flip":hparams.scale_flip}
